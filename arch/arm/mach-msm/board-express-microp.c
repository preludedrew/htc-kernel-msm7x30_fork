/* linux/arch/arm/mach-msm/board-express-microp.c
 *
...
static struct i2c_client *express_microp_client;

static int express_microp_function_init(struct i2c_client *client)
{
...
static struct microp_ops ops = {
	.init_microp_func = express_microp_function_init,
};
